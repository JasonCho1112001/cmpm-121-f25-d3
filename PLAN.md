...
6. Make a graphic showing the contents within a cell (tokens and what value they have)
7. Make the cells clickable and interactable

8. Spawn tokens in cells using the luck function (Already done in step 5)
